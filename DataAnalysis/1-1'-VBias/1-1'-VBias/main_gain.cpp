...
int main(int argc, char ** argv) {
    ...
    y_point.push_back(readNUM("/Users/matteocapitani/Desktop/Università/3 Anno/Lab Nucleare👨🏼‍🔬/DataAnalysis/1-1'-VBias/1-1'-VBias/data/gain24.dat"));
    y_point.push_back(readNUM("/Users/matteocapitani/Desktop/Università/3 Anno/Lab Nucleare👨🏼‍🔬/DataAnalysis/1-1'-VBias/1-1'-VBias/data/gain35.dat"));
    y_point.push_back(readNUM("/Users/matteocapitani/Desktop/Università/3 Anno/Lab Nucleare👨🏼‍🔬/DataAnalysis/1-1'-VBias/1-1'-VBias/data/gain60.dat"));
    y_point.push_back(readNUM("/Users/matteocapitani/Desktop/Università/3 Anno/Lab Nucleare👨🏼‍🔬/DataAnalysis/1-1'-VBias/1-1'-VBias/data/gain70.dat"));
    y_point.push_back(readNUM("/Users/matteocapitani/Desktop/Università/3 Anno/Lab Nucleare👨🏼‍🔬/DataAnalysis/1-1'-VBias/1-1'-VBias/data/gain100.dat"));

    
    vector<TString> titles = readCHAR("/Users/matteocapitani/Desktop/Università/3 Anno/Lab Nucleare👨🏼‍🔬/DataAnalysis/1-1'-VBias/1-1'-VBias/data/Titles_gain.txt");
    vector<vector<double>> ranges = readRANGE("/Users/matteocapitani/Desktop/Università/3 Anno/Lab Nucleare👨🏼‍🔬/DataAnalysis/1-1'-VBias/1-1'-VBias/data/Ranges_gain.txt");
